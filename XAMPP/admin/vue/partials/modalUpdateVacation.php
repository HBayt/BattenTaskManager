...
<script> 
    ...
    $(document).ready(function() { 
        ...
        $('input[id^="dpicker_updatestart"]').each(function() {
            ...
            flatpickr("#dpicker_updatestart-" + id, {dateFormat: "d.m.Y", weekNumbers: true});
            $('#dpicker_updatestart-' + id).change(function() { 
                let startDate = document.querySelector('#dpicker_updatestart-' + id)._flatpickr.selectedDates[0];
                flatpickr("#dpicker_updateend-" + id, {dateFormat: "d.m.Y", minDate: startDate});
            });


            flatpickr("#dpicker_updateend-" + id, {dateFormat: "d.m.Y", weekNumbers: true});
            $('#dpicker_updateend-' + id).change(function() { 
                let endDate = document.querySelector('#dpicker_updateend-' + id)._flatpickr.selectedDates[0];
                flatpickr("#dpicker_updatestart-" + id, {dateFormat: "d.m.Y", maxDate: endDate});
            });
